...
//           tt <- 1/n * t(Xstar - s * X %*% R) %*% matrix(1, n, 1)
    ...
    /*
     * Self-written constructor to create Procrustes instances directly from
     * matrices etc.
     */
    public Procrustes(RealMatrix R_, RealMatrix T_, double dilation){
    	this.s = dilation ;
    	this.R = R_ ;
    	this.T = T_ ;
    	this.columnDimension = R.getColumnDimension();
    	this.rowDimension = R.getRowDimension() ;
    }
